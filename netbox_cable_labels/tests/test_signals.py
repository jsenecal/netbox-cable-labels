...
class CableSignalTestCase(TestCase):
    ...
    def test_cable_label_auto_generated_on_create(self):
        ...
        cable = Cable(a_terminations=[self.interface_a], b_terminations=[self.interface_b])
        cable.save()
    ...
    def test_cable_label_not_overwritten(self):
        ...
        cable = Cable(label=custom_label, a_terminations=[self.interface_a], b_terminations=[self.interface_b])
        cable.save()
    ...
    def test_cable_label_generated_on_update_when_empty(self):
        ...
        cable = Cable(label="temporary", a_terminations=[self.interface_a], b_terminations=[self.interface_b])
        cable.save()
